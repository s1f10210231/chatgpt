...
def SF(request):
    if request.method == 'POST':
        ...
        return render(request,'story_app/SF.html',content)
    else:
        return render(request,'story_app/SF.html')
...
def Free(request):
    if request.method == 'POST':
        ...
        return render(request,'story_app/Free.html',content)
    else:
        return render(request,'story_app/Free.html')
